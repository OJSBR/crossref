...
/**
 * @file plugins/generic/crossref/tests/PluginTest.php
 *
...
class PluginTest extends TestCase
{
    ...
    {
        return [
            \APP\plugins\generic\crossref\CrossrefExportPlugin::class,
            \APP\plugins\generic\crossref\CrossrefPlugin::class,
            \APP\plugins\generic\crossref\classes\CrossrefSettings::class,
            \APP\plugins\generic\crossref\filter\MonographCrossrefXmlFilter::class,
        ];
    }
