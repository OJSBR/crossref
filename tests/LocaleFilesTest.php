...
/**
 * @file plugins/generic/crossref/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends TestCase
{
    ...
    public const PLACEHOLDERS = [
        'plugins.generic.crossref.successMessage' => ['{$submissionId}'],
        'plugins.importexport.crossref.error.publisherNotConfigured' => ['{$contextSettingsUrl}'],
        'plugins.importexport.crossref.register.success.warning' => ['{$param}'],
        'plugins.importexport.common.register.error.mdsError' => ['{$param}'],
    ];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
