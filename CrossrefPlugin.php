 ...
 *
 * @brief Plugin to let managers deposit monograph and chapter DOIs and metadata to Crossref
 */
...
class CrossrefPlugin extends GenericPlugin implements IDoiRegistrationAgency
{
    ...
    public function isPluginConfigured(Context $context): bool
    {
        ...
        // Crossref book deposits require a publisher name in the metadata.
    ...
    public function exportSubmissions(array $submissions, Context $context): array
    {
        ...
        $temporaryFileId = $exportPlugin->exportAsDownload($context, $submissions, $filterName, 'monographs', null, $xmlErrors);
    ...
    {
        return [Repo::doi()::TYPE_PUBLICATION, Repo::doi()::TYPE_CHAPTER];
    }
}
